...
layui.use(['form', 'layedit', 'laydate'], function(){
    ...
    form.on('submit(demo1)', function(data){
      let good = {
        ...
        businessPhone : '000000000000000',
        remnantInventoey : document.forms['good-form']['remnantInventoey'].value,
        ...
        cumulativeSales : document.forms['good-form']['cumulativeSales'].value
      }
      layer.alert(good.photo);
